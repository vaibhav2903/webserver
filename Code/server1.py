...
class HTTPServerI:
    ...
    def handle_request(self, connection, address, request):
        ...
        try:
            ...
            if len(request_details) == 1:
                ...
                connection.close()
                return
            method, uri, http_version, headers, body = request_details
            ...
            if method == "GET":
                resp = self.get_response(absolute_path)
            elif method == "POST":
    ...
    # def build_response(self, path, method, headers=None, body=None, status_code=None):
    #     abs_path = os.path.join(os.getcwd(), path.lstrip('/'))
    #     if method == "GET":
    #         return self.get_response(abs_path)
    #     elif method == "POST":
    #         return self.post_response()
    #     elif method == "PUT":
    #         return self.put_response(abs_path, headers, body)
    #     elif method == "DELETE":
    #         print("Hello")
